/**
 * Shared e2e test: GraphQL API for catalog entity (with-auto-id).
 *
 * Backend-agnostic — runs against whichever implementation
...
describe(`shared e2e [${backend.name}]: GraphQL API for catalog (with-auto-id)`, () => {
